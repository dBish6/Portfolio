                  ...
                  >
                    ...
                    <PopoverBody>
                      ...
                      <UnorderedList fontSize="14px">
                        <ListItem>
                          Resets dealerViewWidthOnMoreCards state properly now;
                        ...
                        <ListItem>
                          ...
                          on no condition. If you change the mode and you're
                          losing in Match mode, it would be cheating. So,
                          changing the modes is changed around now and it
                          doesn't let you change the mode when a game is playing
                          in Match mode.
                        </ListItem>
                        <ListItem>
                          Fixed how the score didn't update when the player gets
                          an Ace as the first card.
                        </ListItem>
                      </UnorderedList>
                      <Divider m="0.5rem 0" />
                      <Heading
                      ...
                      <UnorderedList fontSize="14px">
                        ...
                        <ListItem>
                          Fixed the duration of the exit animation for the
                          cards, it was too slow.
                        </ListItem>
                      </UnorderedList>
                      <Divider m="0.5rem 0" />
                      <Heading
                      ...
                      <UnorderedList fontSize="14px">
                        ...
                        <ListItem>
                          Adds 3 sound variations when given cards for the
                        ...
                        <ListItem>
                          Had to fix when the dealer gets a natural regarding
                          how the showAcePrompt useEffect ran at the same time
                          as the naturals useEffect.
                        </ListItem>
                        <ListItem>
                          Fixes when the player bets and has a balance of 0
                          after the bet; couldn't play because the buttons gets
                          disabled if the balance is falsy, now everything
                          checks if the balance is null.
                        </ListItem>
                      </UnorderedList>
                      <Divider m="0.5rem 0" />
                      <Heading
                      ...
                      <UnorderedList fontSize="14px">
                        ...
                        <ListItem>
                          Implements new redux state, streak, to keep track of
                          the player's wins in a row for "On a Role" quest and
                          adds "Beginner's Luck" quest.
                        </ListItem>
                        <ListItem>
                          Changes regarding how the completedQuests state and
                          wallet state is handled is not in redux anymore and
                          used in the authContext now, so changes was made how
                          the balance is handled.
                        </ListItem>
                      ...
                      <UnorderedList fontSize="14px">
                        <ListItem>
                          ...
                          mistake, in blackjack the dealer waits for the player
                          to finish (if the player gets blackjack, stands or
                          bust). The way I had it, the dealers turn ran when the
                          player makes their first decision (if the player hit
                          or stand). But now Davy Blackjack works like blackjack
                          should.
                        </ListItem>
                        <ListItem>
